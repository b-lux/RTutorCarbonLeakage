...
# Display regression results with robust standard errors clustered by four digit sectors
showreg(list(reg), robust = T, robust.type = "cluster", cluster1 = "sec4dig", digits = 3)
```
...
# The 'effectplot()' function cannot deal with factor variables in the regression
# formula. The 'expanded.regression.data()' command therefore creates a new data 
# frame in which the factors of 'country' are converted into dummy variables.
